...
3. If customization of daisyUI styles using Tailwind CSS utility classes didn't
   ...
   `btn bg-red-500!` sets a custom background colour on a `btn` with higher
   specificity. This is a last resort solution and should be used sparingly
...
10. Suggestion: when designing a page, use `base-*` colours for the majority of
    the page and use `primary` colour for important elements.
